...
declare module 'wevu' {
  export interface GlobalComponents {
    ...
    TForm: __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form/form"), WeappComponent<ComponentProp<"t-form">>>;
    't-form': __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form/form"), WeappComponent<ComponentProp<"t-form">>>;
    TFormItem: __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form-item/form-item"), WeappComponent<ComponentProp<"t-form-item">>>;
    't-form-item': __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form-item/form-item"), WeappComponent<ComponentProp<"t-form-item">>>;
...
declare global {
  ...
  const TForm: __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form/form"), WeappComponent<ComponentProp<"t-form">>>
  const TFormItem: __WeappComponentImport<typeof import("tdesign-miniprogram/miniprogram_dist/form-item/form-item"), WeappComponent<ComponentProp<"t-form-item">>>
